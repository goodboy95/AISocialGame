...
public class AdminIntegrationController {
    ...
    public AdminIntegrationController(AdminAuthService adminAuthService, AdminOpsService adminOpsService) {
        this.adminAuthService = adminAuthService;
        this.adminOpsService = adminOpsService;
    }

    @GetMapping("/services")
    public ResponseEntity<AdminIntegrationStatusResponse> services(
